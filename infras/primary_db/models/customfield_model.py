...
class CustomerCustomFields(BASE):
...
class CustomerCustomFieldsValues(BASE):
    __tablename__="customer_custom_fields_values"
    id=Column(String,primary_key=True)
    shop_id=Column(String)
    ...
    __table_args__ = (
        ...
        UniqueConstraint("customer_id", "field_id", name="uq_customer_field_value"),
    )
