...
class CustomFieldsService:
    ...
    async def get_values_by_customer(self, customer_id: str, shop_id: str) -> list:
        return await self.repo.get_values_by_customer_id(customer_id=customer_id, shop_id=shop_id)
